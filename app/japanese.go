...
const DRILL_COOLDOWN_RANK_4 = 60 * 60 * 24 * 180 // 180 days in seconds
const DRILL_COOLDOWN_RANK_3 = 60 * 60 * 24 * 30  // 30 days weeks in seconds
const DRILL_COOLDOWN_RANK_2 = 60 * 60 * 24 * 2   // 3 days in seconds
